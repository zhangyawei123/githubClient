        ...
        <dd>
          <div class="video-title">
            <el-input v-model="title" placeholder="请输入视频标题" :maxlength="30">
              <!--<i slot="suffix" class="el-input__icon">{{title.length}} / 80</i>-->
            </el-input>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        let _this = this;
        this.axios.get(httpUrl + 'api/company/dynamic/new/edit/index?accessToken=' + this.$cookie.get('accessToken') + '&did=' + this.$route.query.did)
          .then(function (response) {
          console.log(response.data);
          _this.tableData = response.data.data;
          _this.title = response.data.data.title;
          _this.vids = response.data.data.vid;
          _this.eids = response.data.data.eid;
      ...
      getBannerData(data) {
        ...
        this.tableData.productTitle = data.title || data.brandName + data.modelNum;
      ...
      saveData() {
        ...
        let _this = this;
        this.axios.post(httpUrl + 'api/company/dynamic/new/edit/update',this.qs.stringify({
