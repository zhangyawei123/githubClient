<template>
  <div style="padding: 10px 40px 30px;background: #fff;">
    <table>
      <thead>
      <tr>
        <td class="name">标题</td>
        <td class="price">类别</td>
        <td class="view-count">浏览数</td>
        <td class="collect-count">收藏数</td>
        <td class="seek-count">评论数</td>
      ...
      <tbody>
      <tr>
        <td class="name">斗山 PUMA VST</td>
        <td>￥999999</td>
        <td>366</td>
        <td>1555</td>
        <td>1555</td>
        <td>2016年11月16日 16:00</td>
        <td>
