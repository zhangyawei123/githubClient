  ...
  <div>
    <div class="date-panel">
      ...
      <div class="poster-data-cell">
        <div class="poster-cell-title">海报播放数据</div>
        <div class="poster-cell-content">
          <div class="poster-cell-content-item">
            <div class="poster-cell-content-item-icon poster-cell-content-item-icon1"></div>
            <div class="poster-cell-content-item-info">
              <div class="poster-play-key">播放 (次)</div>
              <div class="poster-play-value">1000</div>
            </div>
          </div>
          <div class="poster-cell-content-item">
            <div class="poster-cell-content-item-icon poster-cell-content-item-icon2"></div>
            <div class="poster-cell-content-item-info">
              <div class="poster-play-key">平均播放时长</div>
              <div class="poster-play-value">02:00</div>
            </div>
          </div>
          <div class="poster-cell-content-item">
            <div class="poster-cell-content-item-icon poster-cell-content-item-icon3"></div>
            <div class="poster-cell-content-item-info">
              <div class="poster-play-key">平均播放进度</div>
              <div class="poster-play-value">70%</div>
            </div>
          </div>
          <div class="poster-cell-content-item poster-cell-content-item-last">
            <div class="poster-cell-content-item-icon poster-cell-content-item-icon4"></div>
            <div class="poster-cell-content-item-info">
