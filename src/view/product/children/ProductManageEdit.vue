    ...
    <div>
      <div class="crumbs">
        <div class="crumbs-inner">
          <router-link to="/productManage">返回上一级</router-link><i class="crumbs-icon">|</i><router-link to="/productManage">产品管理</router-link><i class="crumbs-icon">&gt;</i><span>产品信息编辑</span>
        </div>
      </div>
      <div class="product-info-item product-info-item-first">
        <dl>
          <dt>* 产品属性：</dt>
          <dd>
